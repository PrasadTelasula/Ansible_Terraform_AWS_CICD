...
![Alt text](https://github.com/PrasadTelasula/Ansible_Terraform_AWS_CICD/blob/master/arch_diag/arch_diag.png?raw=true "Architecture")


![Alt text](https://github.com/PrasadTelasula/Ansible_Terraform_AWS_CICD/blob/master/arch_diag/cicd_diag.png?raw=true "CICD")
